...
const response = await fetch("http://localhost:3000/api/v2/videos/init", {
  ...
  headers: {
    ...
    Authorization:
      "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2OTdkZWU3MjVkMGU4NmI4ZTYyODlhNjMiLCJpYXQiOjE3NzAyMzI3NTcsImV4cCI6MTc3MDIzNDU1N30.nNxOD_G7pitonJrmttPS1dXf6jkp0wxtB16iviw_O0U",
  },
  body: JSON.stringify({
...
const urlsResponse = await fetch(
  `http://localhost:3000/api/v2/videos/signed-urls/${videoId}`,
  {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
...
const completeRes = await fetch(
  `http://localhost:3000/api/v2/videos/complete/${videoId}`,
  {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
